...
GO
INSERT Favorito (usuario_id, material_id, data_favoritada, status_favorito)
...
(
   ...
   status_gestante VARCHAR(20) NOT NULL,

   PRIMARY KEY (id),
   FOREIGN KEY(usuario_id) REFERENCES Usuario(id)
)
GO
INSERT Gestante (usuario_id, data_registro, data_nascimento, observacoes, tipo_sanguineo, status_gestante)
VALUES (1, GETDATE(), GETDATE(), 'nenhum sintoma', 'o-', 'ATIVO')
GO
...
(
   ...
   status_historico BIT NOT NULL,

   PRIMARY KEY (id),
   CONSTRAINT fk_gestacao_historico FOREIGN KEY (gestacao_id) REFERENCES Gestacao(id)
)
GO
INSERT INTO GestacaoHistorico (gestacao_id, data_registro, observacoes, peso_materno, pressao_arterial, semana_gestacional, status_historico)
VALUES (1, GETDATE(), 'Muitos enjoos', 75.2, '90/60 mmHg', 36, 1)
GO
